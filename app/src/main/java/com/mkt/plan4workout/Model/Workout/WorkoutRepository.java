...
public class WorkoutRepository {
    ...
    public LiveData<Workout> getWorkoutByDateLD(String date) throws ExecutionException, InterruptedException {
        GetWorkoutByDateLDAsyncTask asyncTask = new GetWorkoutByDateLDAsyncTask(workoutDao, date);
        return asyncTask.execute().get();
    }
    ...
    public List<Workout> getWorkoutsByPlan(int id) throws ExecutionException, InterruptedException {
        GetWorkoutByPlanAsyncTask asyncTask = new GetWorkoutByPlanAsyncTask(workoutDao, id);
        return asyncTask.execute().get();
    }
    ...
    private static class GetWorkoutByDateLDAsyncTask extends AsyncTask<Void, Void, LiveData<Workout>> {
        private WorkoutDao workoutDao;
        private String date;

        private GetWorkoutByDateLDAsyncTask(WorkoutDao workoutDao, String date){
            this.workoutDao = workoutDao;
            this.date = date;
        }
        ...
        protected LiveData<Workout> doInBackground(Void... voids) {
            return workoutDao.getWorkoutByDateLD(date);
        }
    }
    ...
    private static class GetWorkoutByPlanAsyncTask extends AsyncTask<Void, Void, List<Workout>> {
        private WorkoutDao workoutDao;
        private int id;

        private GetWorkoutByPlanAsyncTask(WorkoutDao workoutDao, int id){
            this.workoutDao = workoutDao;
            this.id = id;
        }
        ...
        protected List<Workout> doInBackground(Void... voids) {
            return workoutDao.getWorkoutsByPlan(id);
        }
    }
}
