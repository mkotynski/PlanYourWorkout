...
public class ExerciseToPlanRepository {
    ...
    public void deleteExercisesById(int id){
        new DeleteExercisesById(e2pDao, id).execute();
    }
    ...
    private static class DeleteExercisesById extends AsyncTask<Void, Void, Void> {
        private ExerciseToPlanDao e2pDao;
        private int id;

        private DeleteExercisesById(ExerciseToPlanDao e2pDao, int id){
            this.e2pDao = e2pDao;
            this.id = id;
        }
