...
//
//
//public class CalendarActivityX2 extends AppCompatActivity {
//
...
//                            try {
//                                planViewModel.getPlan(workout.getIdOfPlan()).observe(CalendarActivityX2.this, new Observer<Plan>() {
//                                    @Override
//                                    public void onChanged(Plan plan) {
//                                        Toast.makeText(CalendarActivityX2.this, plan.getName(), Toast.LENGTH_SHORT).show();
//                                    }
//                                });
...
//                    Intent intent = new Intent(CalendarActivityX2.this, WorkoutHistoryActivity.class);
...
//            }
//            if (!exists) {
//                Intent intent = new Intent(CalendarActivityX2.this, AddWorkout.class);
